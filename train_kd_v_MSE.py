...
def get_parser():
    ...
    parser.add_argument("--save-dir", type=str, default="./resultsv2")
    parser.add_argument("--save-name", type=str, default="tmp")

    parser.add_argument("--wandb", action="store_true")
    parser.add_argument("--out-dir", type=str, default="resultsv2")
...
def main(args, list_teachers):
    ...
    for emb_dm in embs_dim:
        knifes.append(nn.Linear(embedder_size[args.student], emb_dm))
...
if __name__ == "__main__":
    ...
    if args.wandb:
        wandb.init(
            project="distill-MSE-v2-" + args.student,
    ...
    main(args, list(teachers_dict.keys()))