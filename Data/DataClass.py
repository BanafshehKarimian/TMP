...
class CIFAR10DataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True,transform = None):
        ...
        self.test_data = torchvision.datasets.CIFAR10(root = "./Data", train = False, download = download, transform=self.transform)
        self.training_data, self.valid_data = torch.utils.data.random_split(self.training_data, [0.8, 0.2], generator=g)
...
class FashionMNISTDataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        self.test_data = torchvision.datasets.FashionMNIST(root = "./Data", train = False, download = download, transform=self.transform)
        self.training_data, self.valid_data = torch.utils.data.random_split(self.training_data, [0.8, 0.2], generator=g)
...
class MNISTDataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        self.test_data = torchvision.datasets.MNIST(root = "./Data", train = False, download = download, transform=self.transform)
        self.training_data, self.valid_data = torch.utils.data.random_split(self.training_data, [0.8, 0.2], generator=g)
...
class STL10DataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        self.test_data = torchvision.datasets.STL10(root = "./Data", split = 'test', download = download, transform=self.transform)
        self.training_data, self.valid_data = torch.utils.data.random_split(self.training_data, [0.8, 0.2], generator=g)
...
class SVHNDataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        self.test_data = torchvision.datasets.SVHN(root = "./Data", split = 'test', download = download, transform=self.transform)
        self.training_data, self.valid_data = torch.utils.data.random_split(self.training_data, [0.8, 0.2], generator=g)
...
class QMNISTDataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        self.test_data = torchvision.datasets.QMNIST(root = "./Data", train = False, download = download, transform=self.transform)
        self.training_data, self.valid_data = torch.utils.data.random_split(self.training_data, [0.8, 0.2], generator=g)
...
class KMNISTDataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        self.test_data = torchvision.datasets.KMNIST(root = "./Data", train = False, download = download, transform=self.transform)
        self.training_data, self.valid_data = torch.utils.data.random_split(self.training_data, [0.8, 0.2], generator=g)
...
class Food101DataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        if transform:
            self.transform = transform
        self.training_data = torchvision.datasets.Food101(root = "./Data", split = "train", download = download, transform=self.transform)
        self.test_data = torchvision.datasets.Food101(root = "./Data", split = "test", download = download, transform=self.transform)
        self.training_data, self.valid_data = torch.utils.data.random_split(self.training_data, [0.8, 0.2], generator=g)
...
class DTDDataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        if transform:
            self.transform = transform
        self.training_data = torchvision.datasets.DTD(root = "./Data", split = "train", download = download, transform=self.transform)
...
class FGVCDataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        if transform:
            self.transform = transform
        self.training_data = torchvision.datasets.FGVCAircraft(root = "./Data", split = "train", download = download, transform=self.transform)
        self.test_data = torchvision.datasets.FGVCAircraft(root = "./Data", split = "test", download = download, transform=self.transform)
        self.valid_data = torchvision.datasets.FGVCAircraft(root = "./Data", split = "val", download = download, transform=self.transform)
...
class CUBDataModule(DataModule):
    def __init__(self, batch_size, num_workers, download = True, transform = None):
        ...
        if transform:
            self.transform = transform
        self.training_data = get_cub_train(root = "./Data", train = True, download = download, transform=self.transform)
